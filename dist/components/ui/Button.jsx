...
const Button = forwardRef(({ variant = 'contained', color = 'primary', size = 'medium', fullWidth = false, startIcon, endIcon, loading = false, disabled = false, children, className = '', ...rest }, ref) => {
    // Map legacy MUI-style variants to new variants
    let mappedVariant = 'contained';
    ...
    return (<button ref={ref} disabled={isDisabled} className={classes} {...rest}>
