...
const Dialog = ({ open, onClose, title, children, actions }) => {
    ...
    return (<div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div ref={dialogRef} className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
        ...
        {actions && (<div className="px-6 py-3 border-t flex justify-end space-x-2 bg-gray-50">
            {actions}
          </div>)}
      </div>
    </div>);
