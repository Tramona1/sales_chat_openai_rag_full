...
// Import custom icons
import { MenuIcon, DashboardIcon, ArticleIcon, ApprovalIcon, SettingsIcon } from '../ui/icons';
...
const AdminLayout = ({ children }) => {
    ...
    const drawer = (<div>
      ...
      <Divider />
      <List>
        {menuItems.map((item) => (<Link href={item.href} key={item.text} passHref style={{ textDecoration: 'none', color: 'inherit' }}>
