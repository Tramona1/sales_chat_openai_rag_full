    ...
    return (<div className={styles.container}>
      ...
      <form onSubmit={handleSubmit} className={styles.form}>
        <div className={styles.formGroup}>
          ...
          <input type="text" id="title" value={title} onChange={(e) => setTitle(e.target.value)} className={styles.input} placeholder="Enter a title for this text"/>
        </div>
        ...
        <div className={styles.formGroup}>
          ...
          <textarea id="text" value={text} onChange={(e) => setText(e.target.value)} className={styles.textarea} placeholder="Paste or type your text here..." rows={10} required/>
        </div>

        <button type="submit" className={styles.button} disabled={isSubmitting || !text.trim()}>
      ...
      {result && (<div className={styles.result}>
          ...
          <p>{result.message}</p>
          {result.analysis && (<div className={styles.analysis}>
