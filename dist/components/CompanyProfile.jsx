...
const CompanyProfile = ({ company, onReset }) => {
    ...
    return (<div className="bg-white rounded-xl shadow-md overflow-hidden">
      <div className="p-4 bg-gradient-to-r from-blue-500 to-blue-700 text-white flex justify-between items-center">
        ...
        <button onClick={onReset} className="px-3 py-1 bg-blue-800 hover:bg-blue-900 rounded-md text-sm" title="Search for a different company">
          New Search
        </button>
      </div>
      ...
      <div className="p-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {size && (<div className="flex items-start">
          ...
          {location && (<div className="flex items-start">
              <div className="mr-2 text-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          {founded && (<div className="flex items-start">
              <div className="mr-2 text-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          {website && (<div className="flex items-start">
              <div className="mr-2 text-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
