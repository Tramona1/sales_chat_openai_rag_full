 ...
 */
export type SplitIntoChunksWithContextFn = (text: string, chunkSize?: number, source?: string, generateContext?: boolean, existingContext?: DocumentContext | Record<string, any>) => Promise<ContextualChunk[]>;
/**
 * Type for the extractDocumentContext function signature
 */
export type ExtractDocumentContextFn = (documentText: string, metadata?: Record<string, any>) => Promise<DocumentContext>;
/**
 * Type for the generateChunkContext function signature
 */
export type GenerateChunkContextFn = (chunkText: string, documentContext?: DocumentContext | Record<string, any>) => Promise<ChunkContext>;
