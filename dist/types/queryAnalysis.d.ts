 ...
 */
export type EntityType = 'PERSON' | 'ORGANIZATION' | 'PRODUCT' | 'FEATURE' | 'LOCATION' | 'CONCEPT' | 'TECHNICAL_TERM' | 'OTHER';
/**
 ...
 * Query intent types
 */
export type QueryIntent = 'INFORMATIONAL' | 'TECHNICAL' | 'FEATURE_INQUIRY' | 'COMPARISON' | 'TROUBLESHOOTING' | 'HOW_TO' | 'DEFINITION' | 'PRICING' | 'COMPATIBILITY' | 'OTHER';
/**
