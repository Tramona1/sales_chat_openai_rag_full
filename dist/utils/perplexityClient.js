...
exports.verifyCompanyIdentity = verifyCompanyIdentity;
const axios_1 = __importDefault(require("axios"));
const perplexityUtils_1 = require("./perplexityUtils");
// API constants
 ...
 */
async function getCompanyInformation(companyName, options = {}) {
    var _a, _b;
    try {
        const cacheKey = `company_info_${companyName.toLowerCase().trim().replace(/\s+/g, '_')}`;
        // Check cache first unless force refresh is requested
        if (!options.forceRefresh) {
            const cachedInfo = (0, perplexityUtils_1.getFromCache)(cacheKey);
            if (cachedInfo) {
                (0, perplexityUtils_1.logPerplexityUsage)('getCompanyInformation.cache', { companyName, fromCache: true });
                return {
                    ...cachedInfo,
                    isRateLimited: false
                };
        ...
        if (!checkAndResetRateLimit()) {
            (0, perplexityUtils_1.logPerplexityUsage)('getCompanyInformation.rateLimit', {
                companyName,
                apiCallsInWindow,
                windowStartTime
            });
...
Format the information in clear sections and be factual. If you can't find reliable information, please state that clearly rather than speculating.`;
        ...
        apiCallsInWindow++;
        (0, perplexityUtils_1.logPerplexityUsage)('getCompanyInformation.apiCall', {
            companyName,
            searchMode,
            apiCallsInWindow,
            promptTokens: (_a = response.data.usage) === null || _a === void 0 ? void 0 : _a.prompt_tokens,
            completionTokens: (_b = response.data.usage) === null || _b === void 0 ? void 0 : _b.completion_tokens
        });
        ...
        // Cache the result
        (0, perplexityUtils_1.cacheWithExpiry)(cacheKey, result, COMPANY_INFO_CACHE_TIMEOUT);
        return result;
    }
    catch (error) {
        (0, perplexityUtils_1.logPerplexityUsage)('getCompanyInformation.error', { companyName }, error);
        return {
 ...
 */
async function verifyCompanyIdentity(companyName) {
    var _a, _b;
    try {
        ...
        const cachedInfo = (0, perplexityUtils_1.getFromCache)(cacheKey);
        if (cachedInfo) {
            (0, perplexityUtils_1.logPerplexityUsage)('verifyCompanyIdentity.cache', { companyName, fromCache: true });
            return {
                ...cachedInfo,
                isRateLimited: false
            };
        ...
        // Check rate limiting
        if (!checkAndResetRateLimit()) {
            (0, perplexityUtils_1.logPerplexityUsage)('verifyCompanyIdentity.rateLimit', {
                companyName,
                apiCallsInWindow,
                windowStartTime
            });
...
Do not provide any other information. If you can't find specific information about this company, respond with "Company not found" or if you find multiple distinct companies with this name, list the top 2-3 options.`;
        ...
        // Increment API call counter
        apiCallsInWindow++;
        (0, perplexityUtils_1.logPerplexityUsage)('verifyCompanyIdentity.apiCall', {
            companyName,
            apiCallsInWindow,
            promptTokens: (_a = response.data.usage) === null || _a === void 0 ? void 0 : _a.prompt_tokens,
            completionTokens: (_b = response.data.usage) === null || _b === void 0 ? void 0 : _b.completion_tokens
        ...
        (0, perplexityUtils_1.logPerplexityUsage)('verifyCompanyIdentity.error', { companyName }, error);
        return {
            exists: false,
            isRateLimited: false
        };
