    ...
    return (<Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 mt-8">
          ...
          {/* Training panel */}
          {showTrainPanel && (<div className="mt-8 max-w-2xl mx-auto bg-white p-6 rounded-xl border border-neutral-200 shadow-card">
          ...
          {/* Product information */}
          {showProductInfo && (<div className="mt-8 max-w-4xl mx-auto">
              <h2 className="text-2xl font-bold text-neutral-800 mb-6">Our Product Suite</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {productSuite.map((product, index) => (<div key={index} className="bg-white p-6 rounded-xl border border-neutral-200 shadow-card hover:shadow-card-hover transition flex items-start space-x-4">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {templates.map((template, index) => (<div key={index} className={`${template.color} rounded-xl border overflow-hidden shadow-card hover:shadow-card-hover transition-shadow`}>
                <div className="p-6">
        ...
        <div className="mb-16">
          ...
          <div className="bg-white rounded-xl border border-neutral-200 shadow-card p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {salesFaqs.map((faq, index) => (<button key={index} onClick={() => startChatWithQuestion(faq)} className="text-left py-3 px-4 rounded-lg hover:bg-primary-50 text-neutral-700 border border-neutral-200 hover:border-primary-200 transition">
                  {faq}
                </button>))}
            </div>
          </div>
