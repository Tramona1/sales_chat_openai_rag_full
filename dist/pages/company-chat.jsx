...
${salesNotes.trim() ? salesNotes : "No additional notes provided."}`
    ...
    return (<div className="flex flex-col h-screen bg-[#343541]">
      ...
      <div className="flex-grow overflow-auto">
        {!companyInfo ? (<div className="max-w-md mx-auto mt-10 p-6 bg-[#202123] rounded-xl shadow-lg text-white">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-[#343541]">
              {chatMessages
                ...
                .map((message, index) => (<div key={index} className={`flex ${message.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                    ...
                    : 'bg-[#2a2b32] text-white rounded-bl-none'}`}>
                      ...
                      {message.role === 'assistant' && (<div className="mt-2 pt-2 border-t border-gray-600 flex justify-end gap-2">
            ...
            <div className="border-t border-gray-700 bg-[#3e3f4b] p-4">
              <div className="max-w-4xl mx-auto relative">
                <textarea ref={textareaRef} value={inputMessage} onChange={handleTextareaChange} onKeyDown={handleKeyDown} placeholder="Ask how Workstream can help this company..." className="w-full bg-[#2a2b32] text-white rounded-lg pl-4 pr-12 py-3 focus:outline-none resize-none" rows={1} style={{ maxHeight: '200px' }} disabled={isLoading}/>
                <button onClick={() => {
                handleSendMessage(inputMessage);
                setInputMessage('');
                // Reset textarea height
            ...
            }} disabled={isLoading || !inputMessage.trim()} className={`absolute right-3 top-3 rounded-md p-1 ${isLoading || !inputMessage.trim()
