import { processDocumentWithGemini, convertAnalysisToMetadata, processDocumentWithEnhancedLabels, convertEnhancedAnalysisToMetadata } from '../../../utils/geminiProcessor';
...
export default async function handler(req, res) {
    ...
    try {
        ...
        const { hasConflicts, conflictingDocIds } = await checkForContentConflicts({ source, ...(existingMetadata || {}) }, text);
        ...
        const documentId = await addToPendingDocuments(text, metadata, embedding // Remove the 4th argument (chunks) 
