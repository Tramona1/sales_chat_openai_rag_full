...
async function runExpansionTests() {
    ...
    for (const query of TEST_QUERIES) {
        ...
        try {
            ...
            const hybridResult = await (0, queryExpansion_1.expandQuery)(query, {
                ...testConfig,
                useSemanticExpansion: true,
                useKeywordExpansion: true
            });
            ...
            const semanticResult = await (0, queryExpansion_1.expandQuery)(query, {
                ...testConfig,
                useSemanticExpansion: true,
            ...
            const keywordResult = await (0, queryExpansion_1.expandQuery)(query, {
                ...testConfig,
...
async function testPerformanceImpact() {
    ...
    await (0, queryExpansion_1.expandQuery)(testQuery, {
        useSemanticExpansion: true,
        useKeywordExpansion: false,
