 ...
 */
export function startTimer(trackingId: string): string {
...
function updateComponentMetrics(metric: PerformanceMetric): void {
...
export function getAggregatedMetrics(): ComponentMetrics {
