...
export interface StorageStrategy {
   ...
   * @returns Unique ID for the stored image
   */
   ...
   */
  getPublicUrl(imageId: string): Promise<string>;
 ...
 */
class FileSystemStorageStrategy implements StorageStrategy {
  ...
  async getPublicUrl(imageId: string): Promise<string> {
    try {
...
export const visualStorageStrategy: StorageStrategy = useSupabaseStorage
