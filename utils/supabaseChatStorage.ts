 ...
 */
export async function getSessionsByType(sessionType: 'company' | 'general'): Promise<Array<{
  id: string;
  title: string;
  sessionType: 'company' | 'general';
  updatedAt: string;
 ...
 */
export async function searchChatSessions(query: string): Promise<Array<{
  id: string;
  title: string;
  sessionType: 'company' | 'general';
  updatedAt: string;
 ...
 */
export async function searchChatSessionsByContent(query: string): Promise<Array<{
  id: string;
  title: string;
  sessionType: 'company' | 'general';
  updatedAt: string;
...
export async function updateChatSession(
  ...
  try {
    ...
    if (updates.companyInfo) updateData.company_info = JSON.stringify(updates.companyInfo);
    if (updates.salesNotes !== undefined) updateData.sales_notes = updates.salesNotes;
    if (updates.salesRepId) updateData.sales_rep_id = updates.salesRepId;
    if (updates.salesRepName) updateData.sales_rep_name = updates.salesRepName;
