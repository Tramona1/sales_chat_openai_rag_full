 ...
 */
export function parseEntities(entities: string | ExtractedEntity[] | any): ExtractedEntity[] {
  try {
      ...
      try {
        ...
        if (Array.isArray(parsed)) {
          ...
          if (parsed.people && Array.isArray(parsed.people)) {
            parsed.people.forEach((person: any) => {
          ...
          if (parsed.companies && Array.isArray(parsed.companies)) {
            parsed.companies.forEach((company: any) => {
 ...
 */
export function serializeEntities(entities: ExtractedEntity[] | null | undefined): string | undefined {
 ...
 */
export function getEntityTypeCounts(entities: ExtractedEntity[]): Record<string, number> {
