 ...
 */
async function summarizeItemWithGemini(item: string, query: string): Promise<string> {
  try {
 ...
 */
async function summarizeBatchWithGemini(batch: string, query: string): Promise<string> {
  try {
 ...
 */
async function summarizeFinalWithGemini(batchSummaries: string, query: string): Promise<string> {
  try {
