 ...
 * - Delete a chunk
 */
export default function DocumentChunkViewer({ chunkId, onChunkUpdated, onClose }: DocumentChunkViewerProps) {
  ...
  if (error) {
    return (
      <div style={{ padding: '20px', border: '1px solid', borderColor: '#dc3545', borderRadius: '0.25rem', backgroundColor: '#f8d7da' }}>
        <div style={{ marginBottom: '10px', color: '#dc3545', fontWeight: 'bold' }}>Error</div>
        <div>{error}</div>
        {onClose && (
          <button style={{ marginTop: '20px', padding: '10px 20px', backgroundColor: '#dc3545', color: '#fff', border: 'none', borderRadius: '0.25rem', cursor: 'pointer' }} onClick={onClose}>
            Close
          </button>
        )}
      </div>
  ...
  if (!chunk) {
    return (
      <div style={{ padding: '20px', border: '1px solid', borderColor: '#d3d3d3', borderRadius: '0.25rem' }}>
  ...
  return (
    <div style={{ padding: '20px', borderRadius: '0.25rem', boxShadow: '0 0.125rem 0.25rem rgba(0, 0, 0, 0.075)' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '20px' }}>
        ...
        {onClose && !isEditing && (
          <button style={{ padding: '10px 20px', backgroundColor: '#6c757d', color: '#fff', border: 'none', borderRadius: '4px', cursor: 'pointer' }} onClick={onClose}>
            Close
          </button>
        )}
      </div>
      ...
      <div style={{ marginTop: '20px' }}>
        {snackbar.open && (
          <div style={{ padding: '10px', backgroundColor: '#d1e7dd', border: '1px solid', borderColor: '#a3cfbb', borderRadius: '4px' }}>
            {snackbar.message}
          </div>
        )}
      </div>
