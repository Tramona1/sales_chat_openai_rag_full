...
const EditDocumentModal: React.FC<EditDocumentModalProps> = ({
  ...
  const [editedDocument, setEditedDocument] = useState<DocumentToEdit | null>(null);
  ...
  return (
    ...
    >
      <div className="mb-4">
        ...
        {isChanged && (
          <div className="mt-2 bg-blue-50 text-blue-800 p-2 text-sm rounded">
      ...
      <div className="grid gap-4 py-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Select
            label="Category"
            value={editedDocument.metadata.category || "uncategorized"}
          ...
          <Select
            ...
            value={String(editedDocument.metadata.technicalLevel || "0")}
            onChange={(value) => handleMetadataChange("technicalLevel", parseInt(value))}
        ...
        <TextField
          ...
          value={editedDocument.metadata.keywords || ""}
        ...
        <TextField
          ...
          value={editedDocument.metadata.entities || ""}
          onChange={(e) => handleMetadataChange("entities", e.target.value)}
          fullWidth
        />
        
        <TextField
          label="Summary"
          value={editedDocument.metadata.summary || ""}
